// const textIta = "A partire dal 2015 mi sono appassionato di stampa 3d. nel corso del tempo, oltre a fare esperienza per quanto riguarda il processo, e quindi imparando tutte le dinamiche ed eventuali problematiche che si possono incontrare, ho sviluppato competenze e nozioni pratiche riguardanti la progettazione. La riparazione e la costruzione di stampanti 3d a filamento su misura. Ad oggi, infatti, riparo stampanti per diversi artisti, designer, modellisti e studi di vario genere; oltre alla riparazione fornisco anche consulenze, guide all’acquisto e guide all’utilizzo. Per qualsiasi informazione in più, <a href=\"mailto:leonardo.riccardo.santambrogio@gmail.com\">scaricati il mio portfolio<img src=\"img/LightDownloadIcon.svg\" id=\"DownloadBtn\"></a>";
// const textEng = "Since 2015 I have been passionate about 3d printing. Overtime, in addition to gaining experience regarding the process, and therefore learning all the dynamics and any problems that may be encountered, I have developed skills and practical notions regarding the design, repair and construction of filament 3d printers on measure. To date, in fact, I shelter printers for various artists, designer, model makers and studios of various kinds; in addition to repairs, I also provide advice, purchase guides and user guides. For any further information, <a href=\"mailto:leonardo.riccardo.santambrogio@gmail.com\">download my portfolio<img src=\"img/LightDownloadIcon.svg\" id=\"DownloadBtn\"></a>"
const textIta = `
